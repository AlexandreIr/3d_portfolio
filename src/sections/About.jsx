      ...
      >
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            <img
              ...
              alt="grid-1"
              className="w-full sm:h-[276px] 
                    h-fit object-contain"
            />
            <div>
              <p className="grid-headtext">Hi, I'm Alexandre</p>
        ...
        <div className="col-span-1 xl:row-span-4">
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                I'm based in Brazil, with remote work avaliable.
              </p>
              <Button
                text="Contact Me"
                isBeam={true}
        ...
        <div className="xl:col-span-2 xl:row-span-3">
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                I love solving problems and building things through code. Code
        ...
        <div className="xl:col-span-2 xl:row-span-3">
          <div className="grid-container">
                ...
                className="w-full sm:h-[126px] h-fit object-cover sm:object-top"/>
